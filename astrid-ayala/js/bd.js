let arrayEstudiantes = [
    {carnet: 20235886, nombre: "Alejandro", apellido: "Tobar", nota1: 6.5, nota2: 9.5, nota3: 5},
    {carnet: 20235886, nombre: "Nahomi", apellido: "Serrano", nota1: 7.6, nota2: 9.2, nota3: 10},
    {carnet: 20235886, nombre: "Diego", apellido: "Morales", nota1: 7.0, nota2: 9.5, nota3: 6.6}
]
...
function viewEstudiantes() {
    ...
    if (totalEstudiantes > 0) {
        ...
        table += "<th scope='col'>Parcial 1</th>";
        table += "</tr>";
        table += "</thead>";
        table += "<tbody>";
