let arrayEstudiantes = [
    {carnet: 20235886, nombre: "Alejandro", apellido: "Tobar", nota1: 5, nota2: 6.5, nota3: 4.5, nota4: 8.7},
    {carnet: 20235886, nombre: "Nahomi", apellido: "Serrano", nota1: 8.9, nota2: 7.8, nota3: 7.5, nota4: 9.5},
    {carnet: 20235886, nombre: "Diego", apellido: "Morales", nota1: 5.5, nota2: 7.5, nota3: 8.7, nota4: 7.7}
]
function promedioCalificaciones(){
    ...
    for(const estudiante of arrayEstudiantes){
        sumarNotas += estudiante.nota1 + estudiante.nota2 + estudiante.nota3 + estudiante.nota4
        totalNotas += 4
    }
...
function viewEstudiantes() {
    ...
    if (totalEstudiantes > 0) {
        ...
        table += "<th scope='col'>Tarea 1</th>";
        table += "<th scope='col'>Tarea 2</th>";
        table += "<th scope='col'>Examen Parcial</th>";
        ...
        for (const estudiante of arrayEstudiantes) {
            i++;
            // Desestructuración
            let { carnet, nombre, apellido, nota1, nota2, nota3, nota4 } = estudiante;
