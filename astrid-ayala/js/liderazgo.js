let arrayEstudiantes = [
    {carnet: 20235886, nombre: "Alejandro", apellido: "Tobar", nota1: 7, nota2: 8.1, nota3: 7.7},
    {carnet: 20235886, nombre: "Nahomi", apellido: "Serrano", nota1: 8, nota2: 9.0, nota3: 7},
    {carnet: 20235886, nombre: "Diego", apellido: "Morales", nota1: 6.5, nota2: 5.5, nota3: 9.7}
]
...
function viewEstudiantes() {
    ...
    if (totalEstudiantes > 0) {
        ...
        table += "<th scope='col'>Control 1</th>";
        table += "<th scope='col'>Foro Wonder</th>";
        table += "<th scope='col'>Control 2</th>";
        table += "</tr>";
        table += "</thead>";
        table += "<tbody>";
