let arrayEstudiantes = [
    {carnet: 20235886, nombre: "Alejandro", apellido: "Tobar", nota1: 8, nota2: 7, nota3: 8},
    {carnet: 20235886, nombre: "Nahomi", apellido: "Serrano", nota1: 6, nota2: 7.5, nota3: 8.4},
    {carnet: 20235886, nombre: "Diego", apellido: "Morales", nota1: 8.5, nota2:5.5, nota3: 7.2}
]
...
function viewEstudiantes() {
    ...
    if (totalEstudiantes > 0) {
        ...
        table += "<th scope='col'>Guia 1</th>";
        table += "<th scope='col'>Control 1</th>";
        table += "<th scope='col'>Guia 5</th>";
        table += "</tr>";
        table += "</thead>";
        table += "<tbody>";
